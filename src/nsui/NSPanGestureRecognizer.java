 ...
 * over the native {@code NSPanGestureRecognizer}. Follows the project template:
 * volatile initialized, synchronized ensureInit, ObjC.handle(Sig.of...),
 * invokeExact, static create/wrap.
 *
 * <p>Created via {@code [[NSPanGestureRecognizer alloc] initWithTarget:action:]}.
...
public final class NSPanGestureRecognizer extends NSGestureRecognizer {
    ...
    /** {@code [[NSPanGestureRecognizer alloc] initWithTarget:action:]} — a new pan recognizer. */
