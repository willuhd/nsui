 ...
 * stateless wrapper over a native {@code NSSlider}: every method maps to one
 * {@code objc_msgSend} selector. It is an {@link NSControl} (an {@link NSView}),
 * so it fits any view hierarchy and supports enable/disable via {@link #setEnabled}.
 */
public final class NSSlider extends NSControl {
    ...
    /** {@code [[NSSlider alloc] initWithFrame:frame]} — a new slider at the given rect. */
